...
점수 계산 조건:
- data_csv 디렉토리 아래의 데이터들을 이용한다.
- data_csv 하위 디렉토리명이 길드명이고, 길드명 디렉토리 아래는 날짜이며, 날짜 디렉토리 아래에는 날짜별 데이터를 가지고 있다.
...
- (공격 점수 - 추가 점수)%1초당 점수 == 0을 성립하도록 추가 점수에 0부터 3000까지 값을 넣어보고, 격전지 점수를 6~250 사이로 0.5씩 증가시키며 추정해볼 수 있다.
